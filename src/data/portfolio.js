...
export const portfolioContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary:
        "An interactive web application that visualizes sorting algorithms step by step, helping students understand algorithm flow, comparisons, swaps, and time complexity.",
      techStack: ["HTML", "CSS", "JavaScript"],
      features: [
        "Visualizes popular sorting algorithms with animated bar transitions",
        "Allows users to generate custom arrays and control visualization speed",
        "Displays step-by-step comparison and swapping operations",
        "Responsive UI built for clear algorithm understanding",
      ],
      role: "Designed and developed the complete frontend, implemented sorting logic, created animations, and structured the project for portfolio-ready presentation.",
      status: "Built and documented",
      timeline: "2025",
      architecture:
        "Built as a client-side web application using HTML, CSS, and JavaScript, with sorting logic separated from UI rendering to keep the code modular, readable, and easy to extend.",
      challenges: [
        "Synchronizing algorithm execution with smooth visual animations",
        "Maintaining clean logic separation between sorting operations and DOM updates",
        "Making the visualization simple enough for beginners while still technically meaningful",
  ],
      metrics: ["Multiple sorting algorithms visualized", "Interactive speed and array controls", "Beginner-friendly algorithm learning interface",],
      github: "https://github.com/Aditya-Chauhan24/Sorting-Visualizer#",
      demo: {
        active: true,
        href: "https://sorting-visualizer-alpha-bay.vercel.app/",
      },
      accent: "from-fuchsia-500/20 via-brand-500/10 to-transparent",
      thumbnail: "/images/SV.png",
      visual: {
        label: "System View",
